...
QStringList DownloadWorker::buildArgs() const
{
    ...
    // ── Subtitle download ────────────────────────────────────────────────────
    a << "--write-subs";                        // download subtitles if available
    a << "--write-auto-subs";                   // also auto-generated subs
    a << "--sub-langs" << "en,en-US,en-GB";     // English subs (change as needed)
    a << "--convert-subs" << "srt";             // convert to .srt format

    // ── Thumbnail ────────────────────────────────────────────────────────────
    a << "--write-thumbnail";                   // save thumbnail as .jpg/.webp

    // ── Metadata ─────────────────────────────────────────────────────────────
    a << "--add-metadata";                      // write title, artist, date, etc.
    a << "--write-info-json";                   // save full metadata as .info.json
...
void DownloadWorker::run()
{
    ...
    emit finished(m_item.id, ok,
                  m_aborted ? "Aborted by user"
                            : (ok ? ""
